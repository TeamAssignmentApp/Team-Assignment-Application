		...
		<div class="container">
			...
			<div class="col-md-6">
				<div class="well" style="padding-top:0px;" id="projReqs">
					...
					<a class="btn btn-primary" style="display:inline-block" id="projectButton" onclick="window.open('http://ec2-52-11-229-124.us-west-2.compute.amazonaws.com/viewprojects.php')">List of Projects</a>
				</div>
			</div>
			<div class="col-md-6">
